...
export default function Projects() {
	...
	const c2_description = "C2 server created in Python (Flask) as a command hub to infect computers and run tasks through malicious implants. Implant capabilities (execution, encyrption, looting, file I/O, situational awareness, persistence, and HTTP/S communication) were created in C++ using the Windows API. "
