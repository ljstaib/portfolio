...
export default function Projects() {
	...
	const c2_description = "Worked on a team of five. C2 server created in Python (Flask) as a command hub to infect computers and run tasks through malicious implants. Implant capabilities (execution, encryption, looting, file I/O, situational awareness, persistence, and HTTP/S communication) were created in C++ using the Windows API. "
